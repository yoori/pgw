...
namespace Gears
{
  ...
  public:
     ...
     */
    explicit
    SimpleDecimal(const Gears::SubString& str) /*throw (Overflow, NotNumber)*/;
     ...
     */
    std::string
    dump() const /*throw (Gears::Exception)*/;
     ...
     */
    SimpleDecimal&
    ceil(unsigned fraction) /*throw (Gears::Exception, Overflow)*/;
  ...
  private:
     ...
     */
    void
    construct_(const Gears::SubString& str)
  ...
  std::istream&
  operator >>(std::istream& istr,
    SimpleDecimal<Base, TOTAL, FRACTION>& number) /*throw (Gears::Exception)*/;
